  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{justifyContent: 'center', alignItems: 'center', marginTop: 200}}>
        <Text style={styles.text1}>ohh snap!  No offers yet</Text>
        <Text style={styles.text2}>You dont have any offers</Text>
        <Text style={styles.text2}>yet please check again.</Text>
      </View>
    </View>
  )
}
